    ...
    <div className="flex flex-1 flex-col h-full bg-bg-app overflow-hidden">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            <select 
              ...
              className="h-8 pl-3 pr-8 rounded-md bg-bg-overlay border-none text-[13px] font-semibold text-text-primary outline-none focus:ring-1 focus:ring-accent-blue transition-shadow appearance-none cursor-pointer"
            >
          ...
          <button 
            ...
            className="px-3 py-1.5 rounded-md border border-border-default hover:bg-bg-overlay text-[13px] font-semibold text-text-primary transition-colors shadow-sm cursor-pointer"
          >
            Today
          </button>
          <div className="flex items-center gap-2">
            <button 
              ...
              className="p-1.5 rounded hover:bg-bg-overlay text-text-secondary transition-colors cursor-pointer"
            >
      ...
      {calendarView === 'Month' ? (
        ...
        <div className="flex flex-col flex-1 bg-bg-app overflow-hidden p-4">
          ...
          <div className="grid grid-cols-[80px_1fr] bg-bg-base/50 text-center select-none flex-shrink-0 border-b border-border-subtle py-3 rounded-t-lg">
        ...
        <div className="flex flex-col flex-1 bg-bg-app overflow-hidden p-4">
          ...
          <div className="grid grid-cols-[80px_1fr] bg-bg-base/50 text-center select-none flex-shrink-0 border-b border-border-subtle py-4 rounded-t-lg">
            <div className="text-[11px] font-bold text-text-muted flex items-center justify-center border-r border-border-subtle">
            ...
            <div className="flex flex-col items-center justify-center gap-0.5">
              ...
              <span className={cn(
                "text-[28px] font-bold h-10 w-10 flex items-center justify-center rounded-full",
