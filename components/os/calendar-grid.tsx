...
import { GOOGLE_EVENT_COLOR_CLASSES, getEventColorClasses } from '@/lib/calendar/colors';
...
const googleColorMap = GOOGLE_EVENT_COLOR_CLASSES;
...
export function CalendarGrid({ isModal = false }: { isModal?: boolean }) {
  ...
  const eventsByDate = useMemo(() => {
    ...
    filteredData.forEach((evt, idx) => {
      ...
      const colorClass = getEventColorClasses(evt.colorId, idx, evt.summary);
